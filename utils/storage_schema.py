...
def create_schema(connection):
    ...
    connection.executescript(
        ...
        CREATE INDEX IF NOT EXISTS idx_news_publication_order
            ON news_items(
        ...
        CREATE INDEX IF NOT EXISTS idx_news_source_publication_order
            ON news_items(
                source, publication_date DESC, parsed_date DESC, news_key DESC
            );
