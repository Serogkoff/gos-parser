...
В разделе информагентств подключены РИА Новости и открытая официальная
RSS-лента ТАСС. Для ТАСС внутри «Монитора» показывается официальный анонс,
а полный материал открывается на сайте агентства.
