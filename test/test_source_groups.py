...
class SourceGroupPageTests(unittest.TestCase):
    ...
    def test_agency_page_contains_only_agency_sources(self):
        ...
        self.assertIn(
            f'/static/source-logos/tass.png?v={config.SOURCE_LOGO_VERSION}',
            html,
        )
        self.assertIn(
            f'/static/source-logos/yahoo.png?v={config.SOURCE_LOGO_VERSION}',
            html,
        )
    ...
    def test_government_page_contains_only_government_sources(self):
        ...
        self.assertIn(
            f'/static/source-logos/mchs.png?v={config.SOURCE_LOGO_VERSION}',
            html,
        )
        self.assertIn(
