...
class AuthenticationTests(unittest.TestCase):
    ...
    def test_versioned_source_logos_use_long_public_cache(self):
        response = self.client.get("/static/source-logos/government.png")
        try:
            self.assertEqual(response.status_code, 200)
            self.assertEqual(
    ...
    def test_versioned_feed_scripts_use_long_public_cache(self):
        response = self.client.get("/static/news.js")
        try:
            self.assertEqual(response.status_code, 200)
            self.assertEqual(
                response.headers["Cache-Control"],
    ...
    def test_versioned_notes_styles_use_long_public_cache(self):
        response = self.client.get("/static/notes.css")
        try:
            self.assertEqual(response.status_code, 200)
            self.assertEqual(
                response.headers["Cache-Control"],
